    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.children.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="unique" id="unique" value="{{ old('unique', '') }}" required>
                            @if($errors->has('unique'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('unique') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.child.fields.unique_helper') }}</span>
                        </div>
                        <div class="form-group">
