    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.claims.update", [$claim->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('points') ? 'is-invalid' : '' }}" type="number" name="points" id="points" value="{{ old('points', $claim->points) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount_used') ? 'is-invalid' : '' }}" type="number" name="amount_used" id="amount_used" value="{{ old('amount_used', $claim->amount_used) }}" step="0.01" required>
